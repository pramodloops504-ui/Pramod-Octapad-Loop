.class public Lcom/pramod/loopmidi/AudioEngine;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/pramod/loopmidi/AudioEngine$SampleData;
    }
.end annotation
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-wide v0, p0, Lcom/pramod/loopmidi/AudioEngine;->nativeHandle:J

    .line 48
    iput-object p1, p0, Lcom/pramod/loopmidi/AudioEngine;->context:Landroid/content/Context;

    .line 49
    invoke-direct {p0}, Lcom/pramod/loopmidi/AudioEngine;->nativeCreateAudioEngine()J

    move-result-wide v2

    .line 50
    .local v2, "jNativeCreateAudioEngine":J
    iput-wide v2, p0, Lcom/pramod/loopmidi/AudioEngine;->nativeHandle:J
...
# virtual methods
.method public loadRawSound(II)Lcom/pramod/loopmidi/AudioEngine$SampleData;
    .locals 8
    .param p1, "padIndex"    # I
    .param p2, "resId"    # I
    .annotation system Ldalvik/annotation/Throws;
    ...
    :try_start_0
    iget-wide v2, p0, Lcom/pramod/loopmidi/AudioEngine;->nativeHandle:J
    ...
    .line 107
    iget-object v2, p0, Lcom/pramod/loopmidi/AudioEngine;->context:Landroid/content/Context;
    ...
    .line 111
    invoke-direct {p0, v3}, Lcom/pramod/loopmidi/AudioEngine;->decodePcmFromWav([B)[S
    ...
    .line 113
    new-instance v5, Lcom/pramod/loopmidi/AudioEngine$SampleData;

    invoke-direct {v5}, Lcom/pramod/loopmidi/AudioEngine$SampleData;-><init>()V

    .line 114
    .local v5, "sd":Lcom/pramod/loopmidi/AudioEngine$SampleData;
    iput p2, v5, Lcom/pramod/loopmidi/AudioEngine$SampleData;->soundId:I

    .line 115
    const/4 v6, 0x1

    iput-boolean v6, v5, Lcom/pramod/loopmidi/AudioEngine$SampleData;->loaded:Z

    .line 116
    array-length v6, v4

    invoke-direct {p0, p1, v4, v6}, Lcom/pramod/loopmidi/AudioEngine;->nativeLoadSample(I[SI)V
    ...
    .line 120
    .end local v5    # "sd":Lcom/pramod/loopmidi/AudioEngine$SampleData;
    :cond_1
...
.method public loadWavFromUri(ILandroid/net/Uri;)Lcom/pramod/loopmidi/AudioEngine$SampleData;
    .locals 8
    .param p1, "padIndex"    # I
    ...
    .line 78
    :cond_1
    invoke-direct {p0, v2}, Lcom/pramod/loopmidi/AudioEngine;->readAssetFileDescriptor(Landroid/content/res/AssetFileDescriptor;)[B
    ...
    .line 83
    .local v5, "sd":Lcom/pramod/loopmidi/AudioEngine$SampleData;
    iput-object p2, v5, Lcom/pramod/loopmidi/AudioEngine$SampleData;->uri:Landroid/net/Uri;

    .line 84
    iput p1, v5, Lcom/pramod/loopmidi/AudioEngine$SampleData;->soundId:I
...
.method public playSample(ILcom/pramod/loopmidi/AudioEngine$SampleData;FFI)V
    .locals 15
    .param p1, "padIndex"    # I
    .param p2, "sample"    # Lcom/pramod/loopmidi/AudioEngine$SampleData;
    .param p3, "volume"    # F
    .param p4, "pitch"    # F
    .param p5, "loopMode"    # I
    ...
    invoke-virtual/range {v0 .. v14}, Lcom/pramod/loopmidi/AudioEngine;->playSample(ILcom/pramod/loopmidi/AudioEngine$SampleData;FFIZFFFFFIFF)V

    .line 156
    return-void
.end method

.method public playSample(ILcom/pramod/loopmidi/AudioEngine$SampleData;FFIZFFFFFIFF)V
    .locals 16
    .param p1, "padIndex"    # I
    .param p2, "sample"    # Lcom/pramod/loopmidi/AudioEngine$SampleData;
    .param p3, "volume"    # F
    ...
    :try_start_0
    iget-wide v2, v15, Lcom/pramod/loopmidi/AudioEngine;->nativeHandle:J
    ...
    iget-boolean v0, v1, Lcom/pramod/loopmidi/AudioEngine$SampleData;->loaded:Z
    ...
    invoke-direct/range {v2 .. v14}, Lcom/pramod/loopmidi/AudioEngine;->nativePlaySample(IFFZFFFFFIFF)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public preloadSample(Lcom/pramod/loopmidi/AudioEngine$SampleData;)V
    .locals 0
    .param p1, "sample"    # Lcom/pramod/loopmidi/AudioEngine$SampleData;
...
.method public stop()V
    ...
    .line 62
    iget-wide v0, p0, Lcom/pramod/loopmidi/AudioEngine;->nativeHandle:J
    ...
    .line 63
    invoke-direct {p0}, Lcom/pramod/loopmidi/AudioEngine;->nativeDestroyAudioEngine()V
...
.method public stopAll()V
    ...
    .line 166
    invoke-direct {p0}, Lcom/pramod/loopmidi/AudioEngine;->nativeStopAll()V
...
.method public stopPad(I)V
    ...
    .line 160
    invoke-direct {p0, p1}, Lcom/pramod/loopmidi/AudioEngine;->nativeStopPad(I)V
...
.method public unloadSample(Lcom/pramod/loopmidi/AudioEngine$SampleData;)V
    .locals 1
    .param p1, "sample"    # Lcom/pramod/loopmidi/AudioEngine$SampleData;
    ...
    iput v0, p1, Lcom/pramod/loopmidi/AudioEngine$SampleData;->soundId:I

    .line 134
    iput-boolean v0, p1, Lcom/pramod/loopmidi/AudioEngine$SampleData;->loaded:Z

    .line 135
    const/4 v0, 0x0

    iput-object v0, p1, Lcom/pramod/loopmidi/AudioEngine$SampleData;->uri:Landroid/net/Uri;
