...
public interface ReceiveChannel<E> {
    ...
    Object mo1739receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo1740tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo1740tryReceivePtdJZtk = receiveChannel.mo1740tryReceivePtdJZtk();
            if (ChannelResult.m1757isSuccessimpl(mo1740tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1753getOrThrowimpl(mo1740tryReceivePtdJZtk);
            }
            Throwable m1751exceptionOrNullimpl = ChannelResult.m1751exceptionOrNullimpl(mo1740tryReceivePtdJZtk);
            if (m1751exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m1751exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) {
            ...
            L37:
                ...
                r3 = 1
                r0.label = r3
                java.lang.Object r4 = r4.mo1739receiveCatchingJP2dKIU(r0)
                if (r4 != r2) goto L44
                return r2
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m1752getOrNullimpl(r4)
                return r4
            */
