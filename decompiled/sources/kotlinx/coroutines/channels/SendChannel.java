...
public interface SendChannel<E> {
    ...
    Object mo1732trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object result = sendChannel.mo1732trySendJP2dKIU(e);
            if (ChannelResult.m1757isSuccessimpl(result)) {
                return true;
            }
            Throwable m1751exceptionOrNullimpl = ChannelResult.m1751exceptionOrNullimpl(result);
