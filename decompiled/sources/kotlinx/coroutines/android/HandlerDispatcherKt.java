...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            m227constructorimpl = Result.m227constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), objArr2 == true ? 1 : 0, 2, objArr == true ? 1 : 0));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m227constructorimpl = Result.m227constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m233isFailureimpl(m227constructorimpl) ? null : m227constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo1798dispatch(cont.get$context(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
