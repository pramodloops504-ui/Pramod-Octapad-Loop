    ...
    */
    ...
    public static final Object delay(long timeMillis, Continuation<? super Unit> continuation) {
        ...
        if (timeMillis < Long.MAX_VALUE) {
            getDelay(cont.getContext()).mo1799scheduleResumeAfterDelay(timeMillis, cont);
        }
    ...
    public static final Object m1720delayVtjQ1oo(long duration, Continuation<? super Unit> continuation) {
        Object delay = delay(m1721toDelayMillisLRDsOJo(duration), continuation);
    ...
    public static final long m1721toDelayMillisLRDsOJo(long $this$toDelayMillis_u2dLRDsOJo) {
        boolean m1587isPositiveimpl = Duration.m1587isPositiveimpl($this$toDelayMillis_u2dLRDsOJo);
        if (m1587isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m1571getInWholeMillisecondsimpl(Duration.m1589plusLRDsOJo($this$toDelayMillis_u2dLRDsOJo, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (m1587isPositiveimpl) {
