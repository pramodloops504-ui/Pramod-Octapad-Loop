...
public abstract class FileSystem {
    ...
    public static /* synthetic */ Object m1826write$default(FileSystem $this, Path file, boolean mustCreate, Function1 writerAction, int i, Object obj) throws IOException {
        if (obj == null) {
            if ((i & 2) != 0) {
                mustCreate = false;
            }
    ...
    public final <T> T m1827read(Path file, Function1<? super BufferedSource, ? extends T> readerAction) throws IOException {
        Intrinsics.checkNotNullParameter(file, "file");
    ...
    public final <T> T m1828write(Path file, boolean mustCreate, Function1<? super BufferedSink, ? extends T> writerAction) throws IOException {
        Intrinsics.checkNotNullParameter(file, "file");
        Intrinsics.checkNotNullParameter(writerAction, "writerAction");
