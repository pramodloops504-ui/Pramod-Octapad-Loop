...
public final class SimpleActor<T> {
        ...
        if (job != null) {
            job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: androidx.datastore.core.SimpleActor.1
                ...
                public final void invoke2(Throwable th) {
                    ...
                    do {
                        Object m1752getOrNullimpl = ChannelResult.m1752getOrNullimpl(((SimpleActor) this).messageQueue.mo1740tryReceivePtdJZtk());
                        if (m1752getOrNullimpl != null) {
                            onUndeliveredElement.invoke(m1752getOrNullimpl, th);
                            obj = Unit.INSTANCE;
                        } else {
                            obj = null;
                        }
    ...
    public final void offer(T msg) {
        Object $this$onClosed_u2dWpGqRn0$iv = this.messageQueue.mo1732trySendJP2dKIU(msg);
        if (!($this$onClosed_u2dWpGqRn0$iv instanceof ChannelResult.Closed)) {
            if (!ChannelResult.m1757isSuccessimpl($this$onClosed_u2dWpGqRn0$iv)) {
        ...
        Throwable it = ChannelResult.m1751exceptionOrNullimpl($this$onClosed_u2dWpGqRn0$iv);
        if (it != null) {
            throw it;
        }
    }
