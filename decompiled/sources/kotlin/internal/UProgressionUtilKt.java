...
public final class UProgressionUtilKt {
    ...
    private static final int m1433differenceModuloWZ9TVnA(int a, int b, int c) {
        int compare;
        ...
        return UInt.m322constructorimpl(compare >= 0 ? ac - bc : UInt.m322constructorimpl(ac - bc) + c);
    }

    /* renamed from: differenceModulo-sambcqE, reason: not valid java name */
    private static final long m1434differenceModulosambcqE(long a, long b, long c) {
        int compare;
        ...
        return ULong.m401constructorimpl(compare >= 0 ? ac - bc : ULong.m401constructorimpl(ac - bc) + c);
    }

    /* renamed from: getProgressionLastElement-Nkh28Cs, reason: not valid java name */
    public static final int m1436getProgressionLastElementNkh28Cs(int start, int end, int step) {
        int compare;
        int compare2;
        if (step > 0) {
            compare2 = Integer.compare(start ^ Integer.MIN_VALUE, end ^ Integer.MIN_VALUE);
            if (compare2 < 0) {
                return UInt.m322constructorimpl(end - m1433differenceModuloWZ9TVnA(end, start, UInt.m322constructorimpl(step)));
            }
        } else {
            if (step >= 0) {
            ...
            if (compare > 0) {
                return UInt.m322constructorimpl(m1433differenceModuloWZ9TVnA(start, end, UInt.m322constructorimpl(-step)) + end);
            }
        }
        return end;
    }
    ...
    public static final long m1435getProgressionLastElement7ftBX0g(long start, long end, long step) {
        int compare;
        int compare2;
        if (step > 0) {
            compare2 = Long.compare(start ^ Long.MIN_VALUE, end ^ Long.MIN_VALUE);
            if (compare2 < 0) {
                return ULong.m401constructorimpl(end - m1434differenceModulosambcqE(end, start, ULong.m401constructorimpl(step)));
            }
        } else {
            if (step >= 0) {
                throw new IllegalArgumentException("Step is zero.");
            ...
            if (compare > 0) {
                return ULong.m401constructorimpl(m1434differenceModulosambcqE(start, end, ULong.m401constructorimpl(-step)) + end);
            }
        }
        return end;
    }
