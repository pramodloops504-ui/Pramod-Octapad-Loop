...
public final class Uuid implements Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m395boximpl(ULong.m401constructorimpl(getMostSignificantBits())), ULong.m395boximpl(ULong.m401constructorimpl(getLeastSignificantBits())));
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m1716fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
    ...
    public static final int LEXICAL_ORDER$lambda$2(Uuid a, Uuid b) {
        ...
        if (a.mostSignificantBits != b.mostSignificantBits) {
            compare2 = Long.compare(ULong.m401constructorimpl(a.mostSignificantBits) ^ Long.MIN_VALUE, ULong.m401constructorimpl(b.mostSignificantBits) ^ Long.MIN_VALUE);
            return compare2;
        }
        compare = Long.compare(ULong.m401constructorimpl(a.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m401constructorimpl(b.leastSignificantBits) ^ Long.MIN_VALUE);
        return compare;
    }
}
