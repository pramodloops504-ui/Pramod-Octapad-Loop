...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo1544minusLRDsOJo(long duration);

    /* renamed from: minus-UwyO8pc */
    long mo1545minusUwyO8pc(ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo1546plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m1548minusLRDsOJo(ComparableTimeMark $this, long duration) {
            return $this.mo1546plusLRDsOJo(Duration.m1606unaryMinusUwyO8pc(duration));
        }

        public static int compareTo(ComparableTimeMark $this, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m1552compareToLRDsOJo($this.mo1545minusUwyO8pc(other), Duration.INSTANCE.m1656getZEROUwyO8pc());
        }
    }
}
