...
public final class Duration implements Comparable<Duration> {
    ...
    public static long m1553constructorimpl(long rawValue) {
        if (DurationJvmKt.getDurationAssertionsEnabled()) {
            if (m1584isInNanosimpl(rawValue)) {
                long m1580getValueimpl = m1580getValueimpl(rawValue);
                if (!(-4611686018426999999L <= m1580getValueimpl && m1580getValueimpl < 4611686018427000000L)) {
                    throw new AssertionError(m1580getValueimpl(rawValue) + " ns is out of nanoseconds range");
                }
            } else {
                long m1580getValueimpl2 = m1580getValueimpl(rawValue);
                if (!(-4611686018427387903L <= m1580getValueimpl2 && m1580getValueimpl2 < 4611686018427387904L)) {
                    throw new AssertionError(m1580getValueimpl(rawValue) + " ms is out of milliseconds range");
                }
                long m1580getValueimpl3 = m1580getValueimpl(rawValue);
                if (-4611686018426L <= m1580getValueimpl3 && m1580getValueimpl3 < 4611686018427L) {
    ...
    public static final class Companion {
        ...
        public final Duration m1675parseOrNullFghU774(String value) {
            Intrinsics.checkNotNullParameter(value, "value");
            try {
                return Duration.m1551boximpl(DurationKt.access$parseDuration(value, false));
            } catch (IllegalArgumentException e) {
                return null;
            }
        }
        ...
        public final Duration m1674parseIsoStringOrNullFghU774(String value) {
            Intrinsics.checkNotNullParameter(value, "value");
            try {
                return Duration.m1551boximpl(DurationKt.access$parseDuration(value, true));
            } catch (IllegalArgumentException e) {
                return null;
            }
        }
    ...
    public static final long m1606unaryMinusUwyO8pc(long arg0) {
        return DurationKt.access$durationOf(-m1580getValueimpl(arg0), ((int) arg0) & 1);
    }
    ...
    public static final long m1556divUwyO8pc(long arg0, int scale) {
        ...
        if (m1584isInNanosimpl(arg0)) {
            return DurationKt.access$durationOfNanos(m1580getValueimpl(arg0) / scale);
        }
        if (m1585isInfiniteimpl(arg0)) {
        ...
        if (z) {
            long rem = DurationKt.access$millisToNanos(m1580getValueimpl(arg0) - (scale * result)) / scale;
    ...
    public static final int m1576getNanosecondsComponentimpl(long arg0) {
        ...
        return m1583isInMillisimpl(arg0) ? (int) DurationKt.access$millisToNanos(m1580getValueimpl(arg0) % 1000) : (int) (m1580getValueimpl(arg0) % 1000000000);
    }
    ...
    public static String m1602toStringimpl(long arg0) {
        ...
        int nanoseconds2 = m1576getNanosecondsComponentimpl(arg0$iv);
        ...
        if (hasSeconds) {
            ...
            if (seconds != 0 || hasDays || hasHours) {
                ...
                if (nanoseconds2 >= 1000000) {
                    m1550appendFractionalimpl(arg0, $this$toString_impl_u24lambda_u245, nanoseconds2 / DurationKt.NANOS_IN_MILLIS, nanoseconds2 % DurationKt.NANOS_IN_MILLIS, 6, "ms", false);
                } else if (nanoseconds2 >= 1000) {
                    m1550appendFractionalimpl(arg0, $this$toString_impl_u24lambda_u245, nanoseconds2 / 1000, nanoseconds2 % 1000, 3, "us", false);
                } else {
                    $this$toString_impl_u24lambda_u245.append(nanoseconds2).append("ns");
                }
                components = components4;
            }
            m1550appendFractionalimpl(arg0, $this$toString_impl_u24lambda_u245, seconds, nanoseconds, 9, "s", false);
            components = components4;
        }
    ...
    */
    private static final void m1550appendFractionalimpl(long r13, java.lang.StringBuilder r15, int r16, int r17, int r18, java.lang.String r19, boolean r20) {
        /*
            r0 = r15
            r15.append(r16)
            if (r17 == 0) goto L5b
        ...
        L5d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.time.Duration.m1550appendFractionalimpl(long, java.lang.StringBuilder, int, int, int, java.lang.String, boolean):void");
    }
