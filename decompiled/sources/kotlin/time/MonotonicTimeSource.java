...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m1693boximpl(m1687markNowz9LOYto());
    }
    ...
    public long m1687markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1696constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m1686elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m1685differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m1684adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m1696constructorimpl(LongSaturatedMathKt.m1682saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
