...
public interface TimeMark {
    ...
    TimeMark mo1544minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1546plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1691plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1690minusLRDsOJo(TimeMark $this, long duration) {
            return $this.mo1546plusLRDsOJo(Duration.m1606unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m1586isNegativeimpl($this.mo1543elapsedNowUwyO8pc());
        }
