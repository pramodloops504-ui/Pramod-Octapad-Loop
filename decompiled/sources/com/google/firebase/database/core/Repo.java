...
public class Repo implements PersistentConnection.Delegate {
    ...
    public class AnonymousClass9 implements Runnable {
            ...
            if (serverValue == null) {
                ...
                if (persisted.exists()) {
                    ...
                    repo.scheduleDelayed(new Runnable() { // from class: com.google.firebase.database.core.Repo$9$$ExternalSyntheticLambda0
                        ...
                        public final void run() {
                            TaskCompletionSource.this.trySetResult(persisted);
                        }
                    }, 3000L);
                }
                ...
                task.addOnCompleteListener(executorService, new OnCompleteListener() { // from class: com.google.firebase.database.core.Repo$9$$ExternalSyntheticLambda1
                    ...
                    public final void onComplete(Task task2) {
                        Repo.AnonymousClass9.this.m129lambda$run$1$comgooglefirebasedatabasecoreRepo$9(taskCompletionSource2, persisted, query, repo2, task2);
                    }
                });
                return;
            }
        ...
        public /* synthetic */ void m129lambda$run$1$comgooglefirebasedatabasecoreRepo$9(TaskCompletionSource source, DataSnapshot persisted, Query query, Repo repo, Task task) {
            List<? extends Event> events;
                    ...
                    public void onRequestResult(String optErrorCode, String optErrorMessage) {
                        ...
                        if (error == null) {
                            ...
                            for (final TransactionData txn2 : queue) {
                                ...
                                final DataSnapshot snap = InternalHelpers.createDataSnapshot(InternalHelpers.createReference(repo, txn2.path), IndexedNode.from(node));
