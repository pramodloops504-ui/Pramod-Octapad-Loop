...
public class ActivationActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.btnActivate.setOnClickListener(new View.OnClickListener() { // from class: com.pramod.loopsmidi.ActivationActivity.1
    ...
    public void activateApp() throws DatabaseException {
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener(this) { // from class: com.pramod.loopsmidi.ActivationActivity.2
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                this.this$0.btnActivate.setEnabled(true);
                if (snapshot.exists()) {
                    ...
                    if ("unused".equals(status)) {
                        ...
                        this.this$0.successAndProceed();
                        return;
                    } else if ("used".equals(status) && (str = deviceId) != null && str.equals(dbDeviceId)) {
                        this.this$0.successAndProceed();
                        return;
                    } else {
                        Toast.makeText(this.this$0, "Key is already used on another device!", 1).show();
                        return;
                    }
                }
                Toast.makeText(this.this$0, "Invalid Activation Key!", 1).show();
            }
            ...
            public void onCancelled(DatabaseError error) {
                this.this$0.progressBar.setVisibility(8);
                this.this$0.btnActivate.setEnabled(true);
                Toast.makeText(this.this$0, "Database Error: " + error.getMessage(), 0).show();
            }
        });
    }
