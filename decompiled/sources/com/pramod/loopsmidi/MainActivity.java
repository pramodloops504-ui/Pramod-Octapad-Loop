...
import com.pramod.loopsmidi.AudioEngine;
...
public class MainActivity extends Activity {
    ...
    public void onStopLoopClick(View view) {
        // Stop loops using AudioEngine instead of MediaPlayer
        if (LoopsActivity.globalInstance != null && LoopsActivity.globalInstance.audioEngine != null) {
            LoopsActivity.globalInstance.audioEngine.stopAll();
        }
    }
    ...
    private void setupMidi() {
        ...
        this.midiManager.registerDeviceCallback(new MidiManager.DeviceCallback() { // from class: com.pramod.loopsmidi.MainActivity.1
    ...
    public void openMidiDevice(MidiDeviceInfo info) {
        if (info.getOutputPortCount() > 0) {
            this.midiManager.openDevice(info, new MidiManager.OnDeviceOpenedListener() { // from class: com.pramod.loopsmidi.MainActivity.2
                ...
                public void onDeviceOpened(MidiDevice device) {
                    ...
                    for (int portIndex = 0; portIndex < portCount; portIndex++) {
                        ...
                        if (port != null) {
                            ...
                            port.connect(new MidiReceiver() { // from class: com.pramod.loopsmidi.MainActivity.2.1
    ...
    public void handleMidiNoteOn(byte note, byte velocity) {
        if (this.isVisible) {
            ...
            runOnUiThread(new Runnable(this) { // from class: com.pramod.loopsmidi.MainActivity.3
                ...
                public void run() {
                    ...
                    handler.postDelayed(new Runnable(this) { // from class: com.pramod.loopsmidi.MainActivity.3.1
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (button != null) {
            button.setOnClickListener(new View.OnClickListener() { // from class: com.pramod.loopsmidi.MainActivity.4
        ...
        updateEditButtonUI();
        this.btnEditMode.setOnClickListener(new View.OnClickListener() { // from class: com.pramod.loopsmidi.MainActivity.5
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
        ...
        this.btnRenameKit.setOnClickListener(new View.OnClickListener() { // from class: com.pramod.loopsmidi.MainActivity.6
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                MainActivity.this.renameKitDialog();
            }
        });
        this.btnPrevKit.setOnClickListener(new View.OnClickListener() { // from class: com.pramod.loopsmidi.MainActivity.7
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
        ...
        this.btnNextKit.setOnClickListener(new View.OnClickListener() { // from class: com.pramod.loopsmidi.MainActivity.8
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
        ...
        this.btnLoadKit.setOnClickListener(new View.OnClickListener() { // from class: com.pramod.loopsmidi.MainActivity.9
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
        ...
        this.btnSaveKit.setOnClickListener(new View.OnClickListener() { // from class: com.pramod.loopsmidi.MainActivity.10
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
        ...
        if (button2 != null) {
            button2.setOnClickListener(new View.OnClickListener() { // from class: com.pramod.loopsmidi.MainActivity.11
                @Override // android.view.View.OnClickListener
                public void onClick(View v) {
    ...
    private void initSeekBars() {
        ...
        this.seekVolume.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.pramod.loopsmidi.MainActivity.12
        ...
        this.seekPitch.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.pramod.loopsmidi.MainActivity.13
            @Override // android.widget.SeekBar.OnSeekBarChangeListener
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        this.chkDelay.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.pramod.loopsmidi.MainActivity.14
        ...
        this.seekDelayTime.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.pramod.loopsmidi.MainActivity.15
            @Override // android.widget.SeekBar.OnSeekBarChangeListener
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                if (fromUser) {
        ...
        this.seekDelayLevel.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.pramod.loopsmidi.MainActivity.16
            @Override // android.widget.SeekBar.OnSeekBarChangeListener
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                if (fromUser) {
        ...
        this.seekEqHigh.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.pramod.loopsmidi.MainActivity.17
            @Override // android.widget.SeekBar.OnSeekBarChangeListener
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                if (fromUser) {
        ...
        this.seekEqMid.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.pramod.loopsmidi.MainActivity.18
            @Override // android.widget.SeekBar.OnSeekBarChangeListener
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                if (fromUser) {
        ...
        this.seekEqLow.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.pramod.loopsmidi.MainActivity.19
            @Override // android.widget.SeekBar.OnSeekBarChangeListener
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                if (fromUser) {
        ...
        this.seekChokeGroup.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.pramod.loopsmidi.MainActivity.20
            @Override // android.widget.SeekBar.OnSeekBarChangeListener
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                if (fromUser) {
    ...
    public void showEditPadOptions(final int padIndex) {
        ...
        new AlertDialog.Builder(this).setTitle("PAD " + (padIndex + 1) + " - EDIT OPTIONS").setItems(options, new DialogInterface.OnClickListener(this) { // from class: com.pramod.loopsmidi.MainActivity.21
            final /* synthetic */ MainActivity this$0;
    ...
    public void showSaveKitNameDialog() {
        ...
        new AlertDialog.Builder(this).setTitle("Save Kit As").setView(edt).setPositiveButton("NEXT", new DialogInterface.OnClickListener(this) { // from class: com.pramod.loopsmidi.MainActivity.22
            final /* synthetic */ MainActivity this$0;
    ...
    public void renameKitDialog() {
        final EditText edt = new EditText(this);
        edt.setText(this.currentKitName);
        new AlertDialog.Builder(this).setTitle("Enter Kit Name").setView(edt).setPositiveButton("OK", new DialogInterface.OnClickListener(this) { // from class: com.pramod.loopsmidi.MainActivity.23
            final /* synthetic */ MainActivity this$0;
    ...
    private void showKitListDialog(Uri folderUri) {
        try {
            ...
            new AlertDialog.Builder(this).setTitle("Select Kit").setItems(items, new DialogInterface.OnClickListener(this) { // from class: com.pramod.loopsmidi.MainActivity.25
                final /* synthetic */ MainActivity this$0;
            ...
            }).setNeutralButton("Change Folder", new DialogInterface.OnClickListener() { // from class: com.pramod.loopsmidi.MainActivity.24
                @Override // android.content.DialogInterface.OnClickListener
                public void onClick(DialogInterface dialog, int which) {
