...
public class AudioEngine {
    ...
    public SampleData loadWavFromUri(int padIndex, Uri uri) throws IOException {
        try {
            ...
            afd.close();
            return loadWavFromBytes(padIndex, wavData);
        } catch (Exception e) {
    ...
    public SampleData loadWavFromBytes(int padIndex, byte[] wavData) throws IOException {
        if (this.nativeHandle == 0) {
            return null;
        }
        if (padIndex < 0 || padIndex >= 16) {
        ...
        if (pcmData == null || pcmData.length == 0) {
            Log.e(TAG, "Failed to decode PCM from WAV bytes");
            return null;
        }
        ...
        Log.i(TAG, "Loaded WAV sample bytes to pad " + padIndex + ": " + pcmData.length + " frames");
        return sd;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:33:0x00bb, code lost:
        ...
        android.util.Log.e(com.pramod.loopsmidi.AudioEngine.TAG, "Invalid WAV fmt chunk size");
     */
    ...
    */
    private short[] decodePcmFromWav(byte[] r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.pramod.loopsmidi.AudioEngine.decodePcmFromWav(byte[]):short[]");
    }
